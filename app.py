...
if st.session_state.step >= 2 and st.session_state.ai_data:
    ...
    <div class="pricing-grid">
        <div class="plan">
            ...
            <a href="{RAZORPAY_BASIC}" target="_blank" class="pay-btn">Pay ₹29 →</a>
        </div>
        <div class="plan hot">
            ...
            <a href="{RAZORPAY_PRO}" target="_blank" class="pay-btn">Pay ₹299 →</a>
        </div>
        <div class="plan">
            ...
            <a href="{RAZORPAY_YEARLY}" target="_blank" class="pay-btn">Pay ₹499 →</a>
        </div>
    </div>
    """, unsafe_allow_html=True)
